...
from JAPANESE import CMD_HELP, app
from JAPANESE.nxtgenhelper.data import Data
from JAPANESE.nxtgenhelper.inline import cb_wrapper, paginate_help
from JAPANESE import ids as users
